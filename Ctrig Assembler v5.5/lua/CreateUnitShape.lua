...
function CreateUnitPolygon(PlayerID,Condition,Number,UnitId,Location,ForPlayer,LocX,LocY,PerUnit,SizeofLoc,Radius,Angle,Points,Preserve)
	...
	while true do
			...
			if Main == 1 then
				...
				table.insert(X,CreateUnit(PerUnit,UnitId,Location,ForPlayer))
				Main = 2
				Level = 2
				Remain = Remain - 1
			else
...
function CreateUnitPolygonWithProperties(PlayerID,Condition,Number,UnitId,Location,ForPlayer,LocX,LocY,PerUnit,SizeofLoc,Radius,Angle,Points,Preserve,Properties)
	local LocId = Location
	if type(Location) == "string" then
		LocId =  ParseLocation(LocId)-1
	end
	...
	while true do
			...
			if Main == 1 then
				...
				table.insert(X,SetMemory(0x58DC64+0x14*LocId,SetTo,LocY+dY-SizeofLoc))
				table.insert(X,SetMemory(0x58DC6C+0x14*LocId,SetTo,LocY+dY+SizeofLoc))
				table.insert(X,CreateUnitWithProperties(PerUnit,UnitId,Location,ForPlayer,Properties))
				Main = 2
				Level = 2
				Remain = Remain - 1
			else
...
function CreateUnitPolygonSafe(PlayerID,Condition,Number,UnitId,Location,ForPlayer,PerUnit,SizeofLoc,Radius,Angle,Points,Preserve)
	local LocId = Location
	if type(Location) == "string" then
		LocId =  ParseLocation(LocId)-1
	end
...
function CreateUnitPolygonSafeWithProperties(PlayerID,Condition,Number,UnitId,Location,ForPlayer,PerUnit,SizeofLoc,Radius,Angle,Points,Preserve,Properties)
	local LocId = Location
	if type(Location) == "string" then
		LocId =  ParseLocation(LocId)-1
	end
...
function CreateUnitLine(PlayerID,Condition,Number,UnitId,Location,ForPlayer,LocX,LocY,PerUnit,SizeofLoc,Radius,Angle,Points,Preserve)
	local LocId = Location
	if type(Location) == "string" then
		LocId =  ParseLocation(LocId)-1
	end
...
function CreateUnitLineWithProperties(PlayerID,Condition,Number,UnitId,Location,ForPlayer,LocX,LocY,PerUnit,SizeofLoc,Radius,Angle,Points,Preserve,Properties)
	local LocId = Location
	if type(Location) == "string" then
		LocId =  ParseLocation(LocId)-1
	end
...
function CreateUnitLineSafe(PlayerID,Condition,Number,UnitId,Location,ForPlayer,PerUnit,SizeofLoc,Radius,Angle,Points,Preserve)
	local LocId = Location
	if type(Location) == "string" then
		LocId =  ParseLocation(LocId)-1
	end
...
function CreateUnitLineSafeWithProperties(PlayerID,Condition,Number,UnitId,Location,ForPlayer,PerUnit,SizeofLoc,Radius,Angle,Points,Preserve,Properties)
	local LocId = Location
	if type(Location) == "string" then
		LocId =  ParseLocation(LocId)-1
	end
...
function CreateUnitStar(PlayerID,Condition,Number,UnitId,Location,ForPlayer,LocX,LocY,PerUnit,SizeofLoc,Radius,Angle,Points,StarAngle,Preserve)
	local LocId = Location
	if type(Location) == "string" then
		LocId =  ParseLocation(LocId)-1
	end
...
function CreateUnitStarWithProperties(PlayerID,Condition,Number,UnitId,Location,ForPlayer,LocX,LocY,PerUnit,SizeofLoc,Radius,Angle,Points,StarAngle,Preserve,Properties)
	local LocId = Location
	if type(Location) == "string" then
		LocId =  ParseLocation(LocId)-1
	end
...
function CreateUnitStarSafe(PlayerID,Condition,Number,UnitId,Location,ForPlayer,PerUnit,SizeofLoc,Radius,Angle,Points,StarAngle,Preserve)
	local LocId = Location
	if type(Location) == "string" then
		LocId =  ParseLocation(LocId)-1
	end
...
function CreateUnitStarSafeWithProperties(PlayerID,Condition,Number,UnitId,Location,ForPlayer,PerUnit,SizeofLoc,Radius,Angle,Points,StarAngle,Preserve,Properties)
	local LocId = Location
	if type(Location) == "string" then
		LocId =  ParseLocation(LocId)-1
	end
...
function CreateUnitFlower(PlayerID,Condition,Number,UnitId,Location,ForPlayer,LocX,LocY,PerUnit,SizeofLoc,Radius,Angle,PolarPointsNumerator,PolarPointsDenominator,Partition,RadiusConstant,CenterPoint,Halfdomain,Preserve)
	local LocId = Location
	if type(Location) == "string" then
		LocId =  ParseLocation(LocId)-1
	end
...
function CreateUnitFlowerWithProperties(PlayerID,Condition,Number,UnitId,Location,ForPlayer,LocX,LocY,PerUnit,SizeofLoc,Radius,Angle,PolarPointsNumerator,PolarPointsDenominator,Partition,RadiusConstant,CenterPoint,Halfdomain,Preserve,Properties)
	local LocId = Location
	if type(Location) == "string" then
		LocId =  ParseLocation(LocId)-1
	end
	...
	while true do
			...
			if Main == 1 then
				...
				if CenterPoint == 1 then
					...
					table.insert(X,SetMemory(0x58DC64+0x14*LocId,SetTo,LocY+dY-SizeofLoc))
					table.insert(X,SetMemory(0x58DC6C+0x14*LocId,SetTo,LocY+dY+SizeofLoc))
					table.insert(X,CreateUnit(PerUnit,UnitId,Location,ForPlayer,Properties))
					Remain = Remain - 1
				end
				Main = 2
				Level = 2
...
function CreateUnitFlowerSafe(PlayerID,Condition,Number,UnitId,Location,ForPlayer,PerUnit,SizeofLoc,Radius,Angle,PolarPointsNumerator,PolarPointsDenominator,Partition,RadiusConstant,CenterPoint,Halfdomain,Preserve)
	local LocId = Location
	if type(Location) == "string" then
		LocId =  ParseLocation(LocId)-1
	end
...
function CreateUnitFlowerSafeWithProperties(PlayerID,Condition,Number,UnitId,Location,ForPlayer,PerUnit,SizeofLoc,Radius,Angle,PolarPointsNumerator,PolarPointsDenominator,Partition,RadiusConstant,CenterPoint,Halfdomain,Preserve,Properties)
	local LocId = Location
	if type(Location) == "string" then
		LocId =  ParseLocation(LocId)-1
	end
